const APP_TOKEN = 'WdJzO2HhdsAyoAlq2V27X1V3Y' // <- Replace this with your app token
const RESOURCE_ID = 'jb7j-dtam' // <- Replace this with the ID for the data resource that you want to look up
